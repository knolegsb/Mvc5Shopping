...
namespace Mvc5Shopping.UnitTests
{
    ...
    public class UnitTest2ForCart
    {
        ...
        [TestMethod]
        public void Adding_Product_To_Car_Goes_To_Cart_Screen()
        {
            // Arrange - create the mock repository
            Mock<IProductRepository> mock = new Mock<IProductRepository>();
            mock.Setup(m => m.Products).Returns(new Product[]
        ...
        public void Cannot_Checkout_Empty_Cart()
        {
            ...
            // Arrage - create shipping details
            ShippingDetails shippingDetails = new ShippingDetails();
            ...
            // Assert - check passing an invalid model to the view
        ...
        public void Can_Checkout_And_Submit_Order()
        {
            ...
            // Assert - check passing a valid model to the view
